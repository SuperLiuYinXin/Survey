...
Survey survey=surveydao.findSurvey(Integer.valueOf(Survey_id));
...
<table width="585" border="0" cellspacing="0" cellpadding="0" class="table">
  ...
  <tr>
    <td>同一IP可重复提交</td>
    <td><input name="Survey_ipRepeat" type="checkbox" value=true <%=survey.getSIpRepeat()=='1'?"checked":"" %>></td>
    <td>&nbsp;&nbsp;选中此项，同一IP可重复提交问卷</td>
  </tr>
  <tr>
    <td>公开此问卷调查</td>
    <td><input name="Survey_isOpen" type="checkbox" value=true <%=survey.getSIsOpen()=='1'?"checked":"" %>></td>
