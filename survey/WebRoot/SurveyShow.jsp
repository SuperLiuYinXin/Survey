...
char ipRepeatSetting=survey.getSIpRepeat();
char isIpRepeat=adao.isIpRepeate(sid, request.getRemoteAddr());
if(ipRepeatSetting=='0'&&isIpRepeat=='1'){
	...
	<div id="surveyBox">
		<div class="center">
			<form id="form_survey" name="form1"
				action="survey/ShowSurvey.do?sid=<%=request.getParameter("sid")%>"
				method="post" onsubmit="return ChkForm()">
				<div class="name">
					<b><%=survey.getSName()%></b> <br />
					<%
				...
				<div class="button">
					<input type="submit" value="提交问卷" name="submit1"> <input
						type="reset" value="重新填写" name="reset1">
				</div>
				<div class="backindex">
