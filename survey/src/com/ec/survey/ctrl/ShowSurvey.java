...
public class ShowSurvey extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Survey s=sdao1.findSurvey(Integer.valueOf(sid));
		AnswersheetDAO adao1=DAOFactory.getAnswersheetDAO();
		char ipRepeatSetting=s.getSIpRepeat();
		char isIpRepeat=adao1.isIpRepeate(Integer.valueOf(sid), request.getRemoteAddr());
		...
		char ret=adao.addAnswersheet(sheet);
		if(ret=='0')
			success=false;
		...
		if(success==true) {
			...
			Survey survey=sdao.findSurvey(Integer.valueOf(sid));
			synchronized(this){
